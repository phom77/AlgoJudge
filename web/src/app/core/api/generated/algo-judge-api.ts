...
import { AlgoJudgeApiConfiguration } from './algo-judge-api-configuration';
...
export class AlgoJudgeApi {
  constructor(
    private config: AlgoJudgeApiConfiguration,
   ...
   * will fallback to `AlgoJudgeApiConfiguration.rootUrl`.
   */
  get rootUrl(): string {
