...
import { AlgoJudgeAdminApiConfiguration } from './algo-judge-admin-api-configuration';
...
export class AlgoJudgeAdminApi {
  constructor(
    private config: AlgoJudgeAdminApiConfiguration,
   ...
   * will fallback to `AlgoJudgeAdminApiConfiguration.rootUrl`.
   */
  get rootUrl(): string {
